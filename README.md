...
This is version 1.17.0 of the API ([semver](http://semver.org/)). A list of available endpoints along with brief documentation can be found on its index page.
...
*   [systemd-minecraft](https://github.com/wurstmineberg/systemd-minecraft) (required for `/server/status.json` only)
